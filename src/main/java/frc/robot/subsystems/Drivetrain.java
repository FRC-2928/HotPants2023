...
public class Drivetrain extends SubsystemBase {
    ...
    public static final double MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND = MAX_VELOCITY_METERS_PER_SECOND
            / Math.hypot(DrivetrainConstants.kDrivetrainTrackwidthMeters / 2.0, DrivetrainConstants.kDrivetrainWheelbaseMeters / 2.0);
    ...
    private final Pigeon2 pigeon = new Pigeon2(CANBusIDs.pigeonID);
